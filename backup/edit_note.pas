...
type
  ...
  Tadd = class(TForm)
    ...
    MainMenu: TMainMenu;
    memo: TRichMemo;
    MenuItem_formatt: TMenuItem;
    MenuItem_cptoutf: TMenuItem;
    MenuItem_ansitoutf: TMenuItem;
    MenuItem_open: TMenuItem;
    MenuItem_buttons: TMenuItem;
    MenuItem_toolbar: TMenuItem;
    MenuItem_tree: TMenuItem;
    MenuItem_utf: TMenuItem;
    MenuItem_cp: TMenuItem;
    MenuItem_ansi: TMenuItem;
    MenuItem_utftoansi: TMenuItem;
    MenuItem_utftocp: TMenuItem;
